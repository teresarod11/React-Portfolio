  ...
  return (
    <Card className="bg-dark text-white" sticky="top" style={{ width: '100%', height: '20rem' }}>
      ...
      <Card.Body>
        ...
        Hello! I am a recent graduate of the Full-Stack Coding Bootcamp Program at Georgia Tech. I am very passionate about front-end web development. I am skilled in HTML and CSS to create prototypes, but I am also proficient in JavaScript, jQuery, Bootstrap, etc. 
        </Card.Text>
      </Card.Body>
      </Card.ImgOverlay>
    </Card>
